...
class BiosControllerTest < ActionController::TestCase
  ...
  test "should create bio" do
    assert_difference('Bio.count') do
      post :create, bio: { about: @bio.about, age: @bio.age, certs: @bio.certs, exp;integer: @bio.exp;integer, favs: @bio.favs, gender: @bio.gender, history: @bio.history }
    end
  ...
  test "should update bio" do
    patch :update, id: @bio, bio: { about: @bio.about, age: @bio.age, certs: @bio.certs, exp;integer: @bio.exp;integer, favs: @bio.favs, gender: @bio.gender, history: @bio.history }
    assert_redirected_to bio_path(assigns(:bio))
  end
